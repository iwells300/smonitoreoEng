...
if 'estadoJuramento' not in st.session_state:        
        st.session_state['estadoJuramento'] = True
...
def cargarDatos(listadoEstaciones):
    ...
    if st.session_state.estadoJuramento:
        ...
        st.session_state['estadoJuramento'] = False
...
def recargarDatos():
    ...
    st.session_state['datosWebJuramento'] = archivos
...
listadoEstaciones=['10622','10705','10626','10684','10695','10696','10699','10810','10854','10853','10855','10856','10803','10857','10804','10811','10816','13343','13352','13216','273371']
with st.spinner('Loading data...'):
   archivos=cargarDatos(listadoEstaciones)
if 'datosWebJuramento' not in st.session_state:        
        st.session_state['datosWebJuramento'] = archivos
...
equ=open('assets/ecuacionesJuramento.json', encoding='utf-8')
...
dataArchivos=[]
for a,nombre in st.session_state.datosWebJuramento:
    #data1= json.load(a)
    data1= a
...
if 'zoomJuramento' not in st.session_state:        
        st.session_state['zoomJuramento'] = 7
if 'latJuramento' not in st.session_state:        
        st.session_state['latJuramento'] = -27.640475
if 'lonJuramento' not in st.session_state:        
        st.session_state['lonJuramento'] = -63.452453



m=folium.Map(location=[st.session_state.latJuramento,st.session_state.lonJuramento],zoom_start=st.session_state.zoomJuramento,tiles=folium.TileLayer('https://wms.ign.gob.ar/geoserver/gwc/service/tms/1.0.0/mapabase_topo@EPSG%3A3857@png/{z}/{x}/{-y}.png', name='Argenmap Topográfico', attr='Argenmap Topográfico'), attr='Argenmap Topográfico')
...
with col1:
    st.markdown("## Juramento Salado River")       

    options = st.multiselect(
    ' ',
    nombreEstaciones.keys(),
       
    placeholder="Select station", default=list(nombreEstaciones.keys())[18]) 
    if not options:
...
def sliderChange():
    st.session_state['zoomJuramento']=st_data['zoom']    
    st.session_state['latJuramento']=st_data['center']['lat']
    st.session_state['lonJuramento']=st_data['center']['lng']
