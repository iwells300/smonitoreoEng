...
if 'estadoPilcomayo' not in st.session_state:        
        st.session_state['estadoPilcomayo'] = True
...
def cargarDatos(listadoEstaciones):
    ...
    if st.session_state.estadoPilcomayo:
        ...
        st.session_state['estadoPilcomayo'] = False
...
def recargarDatos():
    ...
    st.session_state['datosWebPilcomayo'] = archivos
...
listadoEstaciones=['10631','12625','12622','12626','12627']
with st.spinner('Loading data...'):
   archivos=cargarDatos(listadoEstaciones)
if 'datosWebPilcomayo' not in st.session_state:        
        st.session_state['datosWebPilcomayo'] = archivos
...
equ=open('assets/ecuacionesPilcomayo.json', encoding='utf-8')
...
dataArchivos=[]
for a,nombre in st.session_state.datosWebPilcomayo:
    #data1= json.load(a)
    data1= a
...
if 'zoomPilcomayo' not in st.session_state:        
        st.session_state['zoomPilcomayo'] = 8
if 'latPilcomayo' not in st.session_state:        
        st.session_state['latPilcomayo'] = -23.473773326954902
if 'lonPilcomayo' not in st.session_state:        
        st.session_state['lonPilcomayo'] = -61.39584191289772 



m=folium.Map(location=[st.session_state.latPilcomayo,st.session_state.lonPilcomayo],zoom_start=st.session_state.zoomPilcomayo,tiles=folium.TileLayer('https://wms.ign.gob.ar/geoserver/gwc/service/tms/1.0.0/mapabase_topo@EPSG%3A3857@png/{z}/{x}/{-y}.png', name='Argenmap Topográfico', attr='Argenmap Topográfico'), attr='Argenmap Topográfico')
...
def sliderChange():
    st.session_state['zoomPilcomayo']=st_data['zoom']    
    st.session_state['latPilcomayo']=st_data['center']['lat']
    st.session_state['lonPilcomayo']=st_data['center']['lng']
