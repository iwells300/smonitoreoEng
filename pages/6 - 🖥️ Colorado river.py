...
if 'estadoColorado' not in st.session_state:        
        st.session_state['estadoColorado'] = True
...
def cargarDatos(listadoEstaciones):
    ...
    if st.session_state.estadoColorado:
        ...
        st.session_state['estadoColorado'] = False
...
def recargarDatos():
    ...
    st.session_state['datosWebColorado'] = archivos
...
listadoEstaciones=['11447','11434','11446','11425','11427','12002','12103','14402','11801','14080','14078']
with st.spinner('Loading data...'):
   archivos=cargarDatos(listadoEstaciones)
if 'datosWebColorado' not in st.session_state:        
        st.session_state['datosWebColorado'] = archivos
...
equ=open('assets/ecuacionesColorado.json', encoding='utf-8')
...
dataArchivos=[]
for a,nombre in st.session_state.datosWebColorado:
    #data1= json.load(a)
    data1= a
...
if 'zoomColorado' not in st.session_state:        
        st.session_state['zoomColorado'] = 7
if 'latColorado' not in st.session_state:        
        st.session_state['latColorado'] = -37.22379494761375
if 'lonColorado' not in st.session_state:        
        st.session_state['lonColorado'] = -66.50569834224683



m=folium.Map(location=[st.session_state.latColorado,st.session_state.lonColorado],zoom_start=st.session_state.zoomColorado,tiles=folium.TileLayer('https://wms.ign.gob.ar/geoserver/gwc/service/tms/1.0.0/mapabase_topo@EPSG%3A3857@png/{z}/{x}/{-y}.png', name='Argenmap Topográfico', attr='Argenmap Topográfico'), attr='Argenmap Topográfico')
...
def sliderChange():
    st.session_state['zoomColorado']=st_data['zoom']    
    st.session_state['latColorado']=st_data['center']['lat']
    st.session_state['lonColorado']=st_data['center']['lng']
